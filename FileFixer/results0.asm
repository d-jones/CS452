...
.word CLASS_Object 
.word fcn_41_main 
.word fcn_76_add100Elements 
.word fcn_123_removeAlternateElements 
CLASS_END_Main: 
CLASS_IntList: 
.word CLASS_Object 
.word fcn_141_init 
...
strLit_205: 
 ...
 .globl fcn_76_add100Elements 
 fcn_76_add100Elements: 
 subu $sp, $sp, 8 
 sw $ra, 4($sp) 
 sw $s2, ($sp) 
 lw $s2, 12($sp) 
 ...
 .globl fcn_123_removeAlternateElements 
 fcn_123_removeAlternateElements: 
 subu $sp, $sp, 8 
 sw $ra, 4($sp) 
 sw $s2, ($sp) 
 lw $s2, 16($sp) 
