...
.word fcn_3_main # ClassDecl at 1.7	
.word fcn_13_method1 # ClassDecl at 1.7	 
.word fcn_40_method2 # ClassDecl at 1.7 
...
.word intToString # ClassDecl at 0.0			
.word intToChar # ClassDecl at 0.0   
.word fcn_3_main # ClassDecl at 0.0 
.word fcn_13_method1 # ClassDecl at 0.0	 	
.word fcn_40_method2 # ClassDecl at 0.0		
...
CLASS_END_Object: # ClassDecl at 0.0	 	
 .data # Program at 1.1   
  .byte 69 # StringLiteral at 7.18 
  .byte 120 # StringLiteral at 7.18  	
  .byte 101 # StringLiteral at 7.18   
  .byte 99 # StringLiteral at 7.18			
  .byte 117 # StringLiteral at 7.18	
  .byte 116 # StringLiteral at 7.18		
  .byte 101 # StringLiteral at 7.18	  
  .byte 100 # StringLiteral at 7.18 		
  .byte 32 # StringLiteral at 7.18 	
  .byte 109 # StringLiteral at 7.18 		
  .byte 101 # StringLiteral at 7.18   
  .byte 116 # StringLiteral at 7.18		
  .byte 104 # StringLiteral at 7.18 	
  .byte 111 # StringLiteral at 7.18		
  .byte 100 # StringLiteral at 7.18 	 
  .byte 49 # StringLiteral at 7.18			
  .byte 40 # StringLiteral at 7.18			
  .byte 41 # StringLiteral at 7.18 		
  .byte 32 # StringLiteral at 7.18	 	
  .byte 61 # StringLiteral at 7.18 		
  .byte 61 # StringLiteral at 7.18		
  .byte 62 # StringLiteral at 7.18	 	
  .byte 32 # StringLiteral at 7.18			
  .byte 80 # StringLiteral at 7.18   
  .byte 65 # StringLiteral at 7.18		 
  .byte 83 # StringLiteral at 7.18	
  .byte 83 # StringLiteral at 7.18 
  .byte 10 # StringLiteral at 7.18	 
  .word CLASS_String # StringLiteral at 7.18 	
  .word 8 # StringLiteral at 7.18 
  .word -28 # StringLiteral at 7.18	
strLit_4: # StringLiteral at 7.18		 
  .byte 66 # StringLiteral at 9.11   
  .byte 65 # StringLiteral at 9.11 
  .byte 76 # StringLiteral at 9.11   
  .byte 76 # StringLiteral at 9.11	 	
  .byte 90 # StringLiteral at 9.11 
  .byte 0 # StringLiteral at 9.11 		
  .byte 0 # StringLiteral at 9.11			
  .byte 0 # StringLiteral at 9.11 		
  .word CLASS_String # StringLiteral at 9.11  	
  .word 3 # StringLiteral at 9.11	  
  .word -5 # StringLiteral at 9.11 		
strLit_8: # StringLiteral at 9.11	
  .byte 115 # StringLiteral at 13.18		 
  .byte 58 # StringLiteral at 13.18			
...
strLit_19: # StringLiteral at 13.18   
  .byte 10 # StringLiteral at 15.18	
  .byte 110 # StringLiteral at 15.18			
  .byte 58 # StringLiteral at 15.18	  
  .byte 32 # StringLiteral at 15.18		
  .word CLASS_String # StringLiteral at 15.18		 
  .word 2 # StringLiteral at 15.18  
  .word -4 # StringLiteral at 15.18   
strLit_27: # StringLiteral at 15.18 
...
strLit_35: # StringLiteral at 17.18			
.text # Program at 1.1 	 
...
.globl fcn_3_main # MethodDeclVoid at 2.14  
fcn_3_main: # MethodDeclVoid at 2.14  
subu $sp, $sp, 8 # MethodDeclVoid at 2.14		 
sw $ra, 4($sp) # MethodDeclVoid at 2.14  	
sw $s2, ($sp) # MethodDeclVoid at 2.14	 
lw $s2, 8($sp) # MethodDeclVoid at 2.14 
subu $sp, $sp, 4 # This at 3.3		
sw $s2, ($sp) # This at 3.3	
lw $t0, 0($sp) # Call at 3.3		
beq $t0, $zero, nullPtrException # Call at 3.3	  
lw $t0, -12($t0) # Call at 3.3	 
lw $t0, 40($t0) # Call at 3.3	  
jalr $t0 # Call at 3.3		 
lw $ra, 4($sp) # MethodDeclVoid at 2.14 		
lw $s2, 8($sp) # MethodDeclVoid at 2.14			
addu $sp, $sp, 12 # MethodDeclVoid at 2.14		 
jr $ra # MethodDeclVoid at 2.14 		
.globl fcn_13_method1 # MethodDeclVoid at 6.14 		
fcn_13_method1: # MethodDeclVoid at 6.14	 	
subu $sp, $sp, 8 # MethodDeclVoid at 6.14   
sw $ra, 4($sp) # MethodDeclVoid at 6.14   
sw $s2, ($sp) # MethodDeclVoid at 6.14	  
lw $s2, 8($sp) # MethodDeclVoid at 6.14	  
subu $sp, $sp, 4 # Super at 7.9		 
sw $s2, ($sp) # Super at 7.9   
subu $sp, $sp, 4 # StringLiteral at 7.18   
la $t0, strLit_4 # StringLiteral at 7.18  	
sw $t0, ($sp) # StringLiteral at 7.18			
jal printStr # Call at 7.9 		
subu $sp, $sp, 4 # This at 9.3	 
sw $s2, ($sp) # This at 9.3			
subu $sp, $sp, 4 # StringLiteral at 9.11			
la $t0, strLit_8 # StringLiteral at 9.11 
sw $t0, ($sp) # StringLiteral at 9.11	 
subu $sp, $sp, 8 # IntegerLiteral at 9.20			
sw $s5, 4($sp) # IntegerLiteral at 9.20  	
li $t0, 100 # IntegerLiteral at 9.20   
sw $t0, ($sp) # IntegerLiteral at 9.20		
lw $t0, 12($sp) # Call at 9.3   
beq $t0, $zero, nullPtrException # Call at 9.3 		
lw $t0, -12($t0) # Call at 9.3			
lw $t0, 44($t0) # Call at 9.3 		
jalr $t0 # Call at 9.3 
addu $sp, $sp, 8 # ExpStatement at 9.3   
lw $ra, 4($sp) # MethodDeclVoid at 6.14		 
lw $s2, 8($sp) # MethodDeclVoid at 6.14 		
addu $sp, $sp, 12 # MethodDeclVoid at 6.14 
jr $ra # MethodDeclVoid at 6.14 	 
.globl fcn_40_method2 # MethodDeclNonVoid at 12.13  
fcn_40_method2: # MethodDeclNonVoid at 12.13			
subu $sp, $sp, 8 # MethodDeclNonVoid at 12.13 	
sw $ra, 4($sp) # MethodDeclNonVoid at 12.13   
sw $s2, ($sp) # MethodDeclNonVoid at 12.13			
lw $s2, 20($sp) # MethodDeclNonVoid at 12.13		
subu $sp, $sp, 4 # Super at 13.9	  
sw $s2, ($sp) # Super at 13.9 
subu $sp, $sp, 4 # StringLiteral at 13.18   
la $t0, strLit_19 # StringLiteral at 13.18		 
sw $t0, ($sp) # StringLiteral at 13.18 
jal printStr # Call at 13.9  
subu $sp, $sp, 4 # Super at 14.9   
sw $s2, ($sp) # Super at 14.9		
lw $t0, 20($sp) # IdentifierExp at 14.18 
subu $sp, $sp, 4 # IdentifierExp at 14.18 		
...
la $t0, strLit_35 # StringLiteral at 17.18 
sw $t0, ($sp) # StringLiteral at 17.18  
jal printStr # Call at 17.9	 	
subu $sp, $sp, 8 # IntegerLiteral at 18.10	 	
sw $s5, 4($sp) # IntegerLiteral at 18.10   
li $t0, 9 # IntegerLiteral at 18.10		
sw $t0, ($sp) # IntegerLiteral at 18.10   
lw $ra, 12($sp) # MethodDeclNonVoid at 12.13	
lw $s2, 20($sp) # MethodDeclNonVoid at 12.13	  
lw $t0, ($sp) # MethodDeclNonVoid at 12.13	 
sw $t0, 24($sp) # MethodDeclNonVoid at 12.13  
sw $s5, 28($sp) # MethodDeclNonVoid at 12.13	
addu $sp, $sp, 24 # MethodDeclNonVoid at 12.13	 	
jr $ra # MethodDeclNonVoid at 12.13	 
###############################################################
