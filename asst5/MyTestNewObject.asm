...
.word fcn_20_main # ClassDecl at 1.7	 	
...
.word intToString # ClassDecl at 0.0			
.word intToChar # ClassDecl at 0.0		 
.word fcn_20_main # ClassDecl at 0.0 
...
CLASS_Test: # ClassDecl at 12.7	  
.word CLASS_Object # ClassDecl at 12.7	  
.word fcn_27_test # ClassDecl at 12.7	
.word concat # ClassDecl at 12.7 	
.word substring # ClassDecl at 12.7  
.word length # ClassDecl at 12.7   
.word charAt # ClassDecl at 12.7			
.word compareTo # ClassDecl at 12.7	
...
.word fcn_20_main # ClassDecl at 12.7 		
CLASS_END_Test: # ClassDecl at 12.7			
CLASS_END_Object: # ClassDecl at 0.0			
 .data # Program at 1.1  
  .byte 116 # StringLiteral at 5.18	
  .byte 101 # StringLiteral at 5.18 
  .byte 115 # StringLiteral at 5.18			
  .byte 116 # StringLiteral at 5.18  
  .byte 46 # StringLiteral at 5.18   
  .byte 97 # StringLiteral at 5.18		 
  .byte 58 # StringLiteral at 5.18 	 
  .byte 32 # StringLiteral at 5.18 
  .word CLASS_String # StringLiteral at 5.18		 
  .word 3 # StringLiteral at 5.18		 
  .word -8 # StringLiteral at 5.18		
strLit_7: # StringLiteral at 5.18  
...
strLit_16: # StringLiteral at 8.18	 
.text # Program at 1.1  	
...
li $s6, 1 # NewObject at 3.15	
li $s7, 0 # NewObject at 3.15 	
jal newObject # NewObject at 3.15 	
la $t0, CLASS_Test # NewObject at 3.15	  
sw $t0, -12($s7) # NewObject at 3.15 		
lw $t0, 0($sp) # IdentifierExp at 4.3	 	
subu $sp, $sp, 4 # IdentifierExp at 4.3 	
sw $t0, ($sp) # IdentifierExp at 4.3 
lw $t0, 0($sp) # Call at 4.8	 
beq $t0, $zero, nullPtrException # Call at 4.8 		
lw $t0, -12($t0) # Call at 4.8		
lw $t0, 4($t0) # Call at 4.8	  
jalr $t0 # Call at 4.8		 
subu $sp, $sp, 4 # Super at 5.9 
sw $s2, ($sp) # Super at 5.9		
subu $sp, $sp, 4 # StringLiteral at 5.18 
la $t0, strLit_7 # StringLiteral at 5.18			
sw $t0, ($sp) # StringLiteral at 5.18		 
jal printStr # Call at 5.9  
subu $sp, $sp, 4 # Super at 6.9	 	
sw $s2, ($sp) # Super at 6.9  
lw $t0, 4($sp) # IdentifierExp at 6.18		 
subu $sp, $sp, 4 # IdentifierExp at 6.18 
sw $t0, ($sp) # IdentifierExp at 6.18  	
lw $t0, ($sp) # InstVarAccess at 6.22			
beq $t0, $zero, nullPtrException # InstVarAccess at 6.22 	 
lw $t0, -16($t0) # InstVarAccess at 6.22  
subu $sp, $sp, 4 # InstVarAccess at 6.22 	 
sw $s5, 4($sp) # InstVarAccess at 6.22			
sw $t0, ($sp) # InstVarAccess at 6.22  	
jal printInt # Call at 6.9 
subu $sp, $sp, 4 # Super at 8.9		 
sw $s2, ($sp) # Super at 8.9	 	
subu $sp, $sp, 4 # StringLiteral at 8.18   
la $t0, strLit_16 # StringLiteral at 8.18			
...
.globl fcn_27_test # MethodDeclVoid at 14.14  
fcn_27_test: # MethodDeclVoid at 14.14		
subu $sp, $sp, 8 # MethodDeclVoid at 14.14	  
sw $ra, 4($sp) # MethodDeclVoid at 14.14		
sw $s2, ($sp) # MethodDeclVoid at 14.14 
lw $s2, 8($sp) # MethodDeclVoid at 14.14	 	
subu $sp, $sp, 8 # IntegerLiteral at 15.7	 	
sw $s5, 4($sp) # IntegerLiteral at 15.7	 	
li $t0, 9 # IntegerLiteral at 15.7	 
sw $t0, ($sp) # IntegerLiteral at 15.7	
lw $t0, ($sp) # Assign at 15.5   
sw $t0, -16($s2) # Assign at 15.5	 
addu $sp, $sp, 8 # Assign at 15.5		
lw $ra, 4($sp) # MethodDeclVoid at 14.14 	
lw $s2, 8($sp) # MethodDeclVoid at 14.14			
addu $sp, $sp, 12 # MethodDeclVoid at 14.14 	
jr $ra # MethodDeclVoid at 14.14		
###############################################################
