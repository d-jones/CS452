...
strLit_27: # StringLiteral at 10.15  	
  ...
  syscall # Program at 3.1  
    # ENTER NODE # MethodDeclVoid at 5.17		 
    ...
    lw $s2, 8($sp) # MethodDeclVoid at 5.17 
      # ENTER NODE # Assign at 6.6  
        # ENTER NODE # NewObject at 6.8	 	
        li $s6, 1 # NewObject at 6.8   
        li $s7, 0 # NewObject at 6.8		
        jal newObject # NewObject at 6.8  	
        la $t0, CLASS_Lib # NewObject at 6.8 
        sw $t0, -12($s7) # NewObject at 6.8   
        # EXIT NODE # NewObject at 6.8	 
      lw $t0, ($sp) # Assign at 6.6  
      sw $t0, 0($s2) # Assign at 6.6 
      addu $sp, $sp, 4 # Assign at 6.6  
      # EXIT NODE # Assign at 6.6  	
      ...
      # ENTER NODE # ExpStatement at 9.6			
        # ENTER NODE # Call at 9.6  	
          # ENTER NODE # IdentifierExp at 9.2 		
          lw $t0, 0($s2) # IdentifierExp at 9.2		
          subu $sp, $sp, 4 # IdentifierExp at 9.2 
          sw $t0, ($sp) # IdentifierExp at 9.2	  
          # EXIT NODE # IdentifierExp at 9.2		
          # ENTER NODE # Call at 9.15 	 
            # ENTER NODE # This at 9.15 	 
            subu $sp, $sp, 4 # This at 9.15 		
            sw $s2, ($sp) # This at 9.15 	
            # EXIT NODE # This at 9.15 	 
            # ENTER NODE # IntegerLiteral at 9.27	
            ...
            # EXIT NODE # IntegerLiteral at 9.27 	 
            # ENTER NODE # IntegerLiteral at 9.30 		
    ...
    # EXIT NODE # MethodDeclVoid at 5.17  
    # ENTER NODE # MethodDeclNonVoid at 12.16  
    ...
    lw $s2, 28($sp) # MethodDeclNonVoid at 12.16  	
      # ENTER NODE # LocalVarDecl at 13.6  	
        # ENTER NODE # Times at 13.18	 	
          # ENTER NODE # IdentifierExp at 13.17	  
          ...
          # EXIT NODE # IdentifierExp at 13.17		 
        ...
        lw $t0, ($sp) # Times at 13.18 	
        lw $t1, 8($sp) # Times at 13.18		 
        mult $t0, $t1 # Times at 13.18	 
        mflo $t0 # Times at 13.18 	 
        addu $sp, $sp, 8 # Times at 13.18   
        sw $t0, ($sp) # Times at 13.18	 	
        # EXIT NODE # Times at 13.18 	 
      # EXIT NODE # LocalVarDecl at 13.6  
      # ENTER NODE # LocalVarDecl at 14.6			
        # ENTER NODE # Times at 14.18  	
          # ENTER NODE # IdentifierExp at 14.17	 
          lw $t0, 20($sp) # IdentifierExp at 14.17   
          subu $sp, $sp, 8 # IdentifierExp at 14.17			
          sw $s5, 4($sp) # IdentifierExp at 14.17 
          sw $t0, ($sp) # IdentifierExp at 14.17 	 
          # EXIT NODE # IdentifierExp at 14.17		
          # ENTER NODE # IdentifierExp at 14.19	
          lw $t0, 28($sp) # IdentifierExp at 14.19			
          subu $sp, $sp, 8 # IdentifierExp at 14.19  	
          sw $s5, 4($sp) # IdentifierExp at 14.19 	 
          sw $t0, ($sp) # IdentifierExp at 14.19  
          # EXIT NODE # IdentifierExp at 14.19		
        lw $t0, ($sp) # Times at 14.18	  
        lw $t1, 8($sp) # Times at 14.18		 
        mult $t0, $t1 # Times at 14.18		
        mflo $t0 # Times at 14.18	 
        addu $sp, $sp, 8 # Times at 14.18  	
        sw $t0, ($sp) # Times at 14.18	 	
        # EXIT NODE # Times at 14.18		
      # EXIT NODE # LocalVarDecl at 14.6 	
      # ENTER NODE # LocalVarDecl at 15.6	 	
        # ENTER NODE # Minus at 15.23  	
          # ENTER NODE # IdentifierExp at 15.15 
          lw $t0, 8($sp) # IdentifierExp at 15.15 	 
          ...
          # ENTER NODE # IdentifierExp at 15.24	 	
          ...
          # EXIT NODE # IdentifierExp at 15.24 		
        ...
        sw $t0, ($sp) # Minus at 15.23  	
          # ENTER NODE # Minus at 15.23			
          # EXIT NODE # LocalVarDecl at 15.6	 
          # ENTER NODE # If at 16.2			
            # ENTER NODE # IdentifierExp at 16.6 		
            lw $t0, 32($sp) # IdentifierExp at 16.6 	 
            subu $sp, $sp, 4 # IdentifierExp at 16.6 
            sw $t0, ($sp) # IdentifierExp at 16.6 	
            # EXIT NODE # IdentifierExp at 16.6  
          lw $t0, ($sp) # If at 16.2	  
          addu $sp, $sp, 4 # If at 16.2	 
          beq $t0, $zero, if_else_61 # If at 16.2 	 
            # ENTER NODE # Block at 16.15 		
              # ENTER NODE # Assign at 17.13		 
                # ENTER NODE # Minus at 17.15   
                  # ENTER NODE # IntegerLiteral at 17.15	 	
                  ...
                  # EXIT NODE # IntegerLiteral at 17.15	
                  # ENTER NODE # IdentifierExp at 17.16  	
                  lw $t0, 8($sp) # IdentifierExp at 17.16   
                  subu $sp, $sp, 8 # IdentifierExp at 17.16  	
                  sw $s5, 4($sp) # IdentifierExp at 17.16 
                  sw $t0, ($sp) # IdentifierExp at 17.16	  
                  # EXIT NODE # IdentifierExp at 17.16 
              ...
              # EXIT NODE # IdentifierExp at 19.9   
            lw $ra, 36($sp) # MethodDeclNonVoid at 12.16  
            lw $s2, 32($sp) # MethodDeclNonVoid at 12.16		 
            lw $t0, ($sp) # MethodDeclNonVoid at 12.16  	
            sw $t0, 56($sp) # MethodDeclNonVoid at 12.16		 
            sw $s5, 60($sp) # MethodDeclNonVoid at 12.16		 
            addu $sp, $sp, 56 # MethodDeclNonVoid at 12.16 	
            jr $ra # MethodDeclNonVoid at 12.16		 
              # ENTER NODE # MethodDeclNonVoid at 12.16	  
              # EXIT NODE # Program at 3.1	  
###############################################################
