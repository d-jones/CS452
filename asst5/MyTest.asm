...
strLit_14: # StringLiteral at 8.15	 
...
strLit_20: # StringLiteral at 11.18	
...
strLit_28: # StringLiteral at 13.18   
...
strLit_36: # StringLiteral at 15.18	 
...
strLit_44: # StringLiteral at 17.18  	
...
strLit_52: # StringLiteral at 19.18	  
...
strLit_60: # StringLiteral at 21.18 		
...
strLit_68: # StringLiteral at 23.18		
...
strLit_76: # StringLiteral at 25.18		
...
strLit_84: # StringLiteral at 27.18   
...
strLit_94: # StringLiteral at 29.18 	 
...
strLit_104: # StringLiteral at 31.18 	 
...
strLit_114: # StringLiteral at 33.18	 
...
strLit_124: # StringLiteral at 35.18 	 
...
strLit_136: # StringLiteral at 37.18	 	
...
strLit_148: # StringLiteral at 39.18 	 
...
strLit_156: # StringLiteral at 42.18 
...
strLit_160: # StringLiteral at 43.18		 
...
strLit_164: # StringLiteral at 44.18  	
...
subu $sp, $sp, 4 # StringLiteral at 11.18   
la $t0, strLit_20 # StringLiteral at 11.18	 
sw $t0, ($sp) # StringLiteral at 11.18 	 
jal printStr # Call at 11.9 	 
subu $sp, $sp, 4 # Super at 12.9	  
sw $s2, ($sp) # Super at 12.9		
lw $t0, 24($sp) # IdentifierExp at 12.18	 
...
la $t0, strLit_36 # StringLiteral at 15.18	
sw $t0, ($sp) # StringLiteral at 15.18   
jal printStr # Call at 15.9  
subu $sp, $sp, 4 # Super at 16.9 		
sw $s2, ($sp) # Super at 16.9  	
lw $t0, 16($sp) # IdentifierExp at 16.18 	 
subu $sp, $sp, 8 # IdentifierExp at 16.18 	 
sw $s5, 4($sp) # IdentifierExp at 16.18 		
sw $t0, ($sp) # IdentifierExp at 16.18	 	
jal printInt # Call at 16.9	 	
subu $sp, $sp, 4 # Super at 17.9			
sw $s2, ($sp) # Super at 17.9	 	
subu $sp, $sp, 4 # StringLiteral at 17.18 	
la $t0, strLit_44 # StringLiteral at 17.18		
sw $t0, ($sp) # StringLiteral at 17.18		
jal printStr # Call at 17.9	 	
subu $sp, $sp, 4 # Super at 18.9		
sw $s2, ($sp) # Super at 18.9 		
lw $t0, 16($sp) # IdentifierExp at 18.18	 	
...
la $t0, strLit_124 # StringLiteral at 35.18 	
sw $t0, ($sp) # StringLiteral at 35.18	 	
jal printStr # Call at 35.9	 
subu $sp, $sp, 4 # Super at 36.9   
sw $s2, ($sp) # Super at 36.9		
lw $t0, 8($sp) # IdentifierExp at 36.18	
subu $sp, $sp, 8 # IdentifierExp at 36.18	 	
sw $s5, 4($sp) # IdentifierExp at 36.18	
sw $t0, ($sp) # IdentifierExp at 36.18 	
lw $t0, 32($sp) # IdentifierExp at 36.22	 	
subu $sp, $sp, 8 # IdentifierExp at 36.22	 	
sw $s5, 4($sp) # IdentifierExp at 36.22  
sw $t0, ($sp) # IdentifierExp at 36.22	
lw $t0, ($sp) # Plus at 36.20 	
lw $t1, 8($sp) # Plus at 36.20	 	
addu $t0, $t0, $t1 # Plus at 36.20 	
addu $sp, $sp, 8 # Plus at 36.20  
sw $t0, ($sp) # Plus at 36.20			
lw $t0, 24($sp) # IdentifierExp at 36.26   
subu $sp, $sp, 8 # IdentifierExp at 36.26	  
sw $s5, 4($sp) # IdentifierExp at 36.26  	
sw $t0, ($sp) # IdentifierExp at 36.26	
lw $t0, ($sp) # Minus at 36.24	
lw $t1, 8($sp) # Minus at 36.24 
subu $t0, $t1, $t0 # Minus at 36.24			
addu $sp, $sp, 8 # Minus at 36.24			
sw $t0, ($sp) # Minus at 36.24 		
jal printInt # Call at 36.9		
subu $sp, $sp, 4 # Super at 37.9 	 
sw $s2, ($sp) # Super at 37.9			
subu $sp, $sp, 4 # StringLiteral at 37.18   
la $t0, strLit_136 # StringLiteral at 37.18   
sw $t0, ($sp) # StringLiteral at 37.18	 
jal printStr # Call at 37.9	 
subu $sp, $sp, 4 # Super at 38.9	  
sw $s2, ($sp) # Super at 38.9  
lw $t0, 16($sp) # IdentifierExp at 38.18 	 
subu $sp, $sp, 8 # IdentifierExp at 38.18 		
sw $s5, 4($sp) # IdentifierExp at 38.18 	 
sw $t0, ($sp) # IdentifierExp at 38.18 	
lw $t0, 32($sp) # IdentifierExp at 38.22	 	
subu $sp, $sp, 8 # IdentifierExp at 38.22   
sw $s5, 4($sp) # IdentifierExp at 38.22 		
sw $t0, ($sp) # IdentifierExp at 38.22  	
lw $t0, ($sp) # Minus at 38.20 	
lw $t1, 8($sp) # Minus at 38.20 
subu $t0, $t1, $t0 # Minus at 38.20 		
addu $sp, $sp, 8 # Minus at 38.20		 
sw $t0, ($sp) # Minus at 38.20  	
lw $t0, 16($sp) # IdentifierExp at 38.26 
subu $sp, $sp, 8 # IdentifierExp at 38.26 		
sw $s5, 4($sp) # IdentifierExp at 38.26  
sw $t0, ($sp) # IdentifierExp at 38.26 		
lw $t0, ($sp) # Plus at 38.24		 
lw $t1, 8($sp) # Plus at 38.24	 	
addu $t0, $t0, $t1 # Plus at 38.24		 
addu $sp, $sp, 8 # Plus at 38.24 		
sw $t0, ($sp) # Plus at 38.24	 	
jal printInt # Call at 38.9		
subu $sp, $sp, 4 # Super at 39.9		 
sw $s2, ($sp) # Super at 39.9  	
subu $sp, $sp, 4 # StringLiteral at 39.18	 
la $t0, strLit_148 # StringLiteral at 39.18 	 
sw $t0, ($sp) # StringLiteral at 39.18 		
jal printStr # Call at 39.9 
subu $sp, $sp, 4 # Super at 41.9 		
sw $s2, ($sp) # Super at 41.9  
lw $t0, 4($sp) # IdentifierExp at 41.18 	 
subu $sp, $sp, 4 # IdentifierExp at 41.18	
...
la $t0, strLit_156 # StringLiteral at 42.18   
...
la $t0, strLit_160 # StringLiteral at 43.18	 	
...
la $t0, strLit_164 # StringLiteral at 44.18	 
sw $t0, ($sp) # StringLiteral at 44.18	
jal printStr # Call at 44.9			
lw $ra, 32($sp) # MethodDeclVoid at 3.14	
lw $s2, 4($sp) # MethodDeclVoid at 3.14  	
addu $sp, $sp, 40 # MethodDeclVoid at 3.14		
