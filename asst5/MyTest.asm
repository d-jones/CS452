...
strLit_14: # StringLiteral at 8.17	
...
strLit_29: # StringLiteral at 15.18 
...
strLit_42: # StringLiteral at 18.18 		
...
strLit_47: # StringLiteral at 20.15	
...
strLit_53: # StringLiteral at 23.18   
...
strLit_61: # StringLiteral at 25.18		
...
strLit_69: # StringLiteral at 27.18		 
...
strLit_77: # StringLiteral at 29.18 	
...
strLit_85: # StringLiteral at 31.18  	
...
strLit_93: # StringLiteral at 33.18  
...
strLit_101: # StringLiteral at 35.18 
...
strLit_109: # StringLiteral at 37.18			
...
strLit_117: # StringLiteral at 39.18   
...
strLit_127: # StringLiteral at 41.18			
...
strLit_137: # StringLiteral at 43.18  	
...
strLit_147: # StringLiteral at 45.18 
...
strLit_157: # StringLiteral at 47.18	 
...
strLit_169: # StringLiteral at 49.18		 
...
strLit_181: # StringLiteral at 51.18	 	
...
strLit_189: # StringLiteral at 54.18		
...
strLit_193: # StringLiteral at 55.18			
...
strLit_197: # StringLiteral at 56.18 	
...
subu $sp, $sp, 4 # StringLiteral at 8.17		
la $t0, strLit_14 # StringLiteral at 8.17 	
sw $t0, ($sp) # StringLiteral at 8.17  	
lw $t0, 0($sp) # IdentifierExp at 9.6		
subu $sp, $sp, 4 # IdentifierExp at 9.6 	
sw $t0, ($sp) # IdentifierExp at 9.6  	
lw $t0, ($sp) # If at 9.3		 
addu $sp, $sp, 4 # If at 9.3			
beq $t0, $zero, if_else_21 # If at 9.3		 
j if_done_21 # If at 9.3			
if_else_21: # If at 9.3	  
if_done_21: # If at 9.3	
subu $sp, $sp, 8 # IntegerLiteral at 13.11	  
sw $s5, 4($sp) # IntegerLiteral at 13.11 	
li $t0, 1 # IntegerLiteral at 13.11	 
...
subu $sp, $sp, 4 # StringLiteral at 15.18 		
la $t0, strLit_29 # StringLiteral at 15.18	 	
sw $t0, ($sp) # StringLiteral at 15.18   
jal printStr # Call at 15.9 	 
lw $t0, 0($sp) # IdentifierExp at 16.7	 
subu $sp, $sp, 8 # IdentifierExp at 16.7 		
sw $s5, 4($sp) # IdentifierExp at 16.7   
sw $t0, ($sp) # IdentifierExp at 16.7 		
subu $sp, $sp, 8 # IntegerLiteral at 16.11			
sw $s5, 4($sp) # IntegerLiteral at 16.11 		
li $t0, 1 # IntegerLiteral at 16.11 		
sw $t0, ($sp) # IntegerLiteral at 16.11  
lw $t0, ($sp) # Plus at 16.9  	
lw $t1, 8($sp) # Plus at 16.9 		
addu $t0, $t0, $t1 # Plus at 16.9 
addu $sp, $sp, 8 # Plus at 16.9	 	
sw $t0, ($sp) # Plus at 16.9  
lw $t0, ($sp) # Assign at 16.5 		
sw $t0, 8($sp) # Assign at 16.5		
addu $sp, $sp, 8 # Assign at 16.5 	 
subu $sp, $sp, 4 # Super at 17.9 	 
sw $s2, ($sp) # Super at 17.9			
lw $t0, 4($sp) # IdentifierExp at 17.18 	
...
la $t0, strLit_109 # StringLiteral at 37.18		 
...
la $t0, strLit_117 # StringLiteral at 39.18	
...
lw $t0, 36($sp) # IdentifierExp at 40.22   
subu $sp, $sp, 8 # IdentifierExp at 40.22	 	
sw $s5, 4($sp) # IdentifierExp at 40.22  	
sw $t0, ($sp) # IdentifierExp at 40.22 	 
lw $t0, ($sp) # Minus at 40.20	
lw $t1, 8($sp) # Minus at 40.20	 	
subu $t0, $t1, $t0 # Minus at 40.20  	
addu $sp, $sp, 8 # Minus at 40.20 	
sw $t0, ($sp) # Minus at 40.20   
jal printInt # Call at 40.9 		
subu $sp, $sp, 4 # Super at 41.9	  
sw $s2, ($sp) # Super at 41.9 	 
subu $sp, $sp, 4 # StringLiteral at 41.18	  
la $t0, strLit_127 # StringLiteral at 41.18	 	
sw $t0, ($sp) # StringLiteral at 41.18	  
jal printStr # Call at 41.9			
subu $sp, $sp, 4 # Super at 42.9	
sw $s2, ($sp) # Super at 42.9	  
lw $t0, 36($sp) # IdentifierExp at 42.18 	 
subu $sp, $sp, 8 # IdentifierExp at 42.18	 	
sw $s5, 4($sp) # IdentifierExp at 42.18	 
sw $t0, ($sp) # IdentifierExp at 42.18 		
lw $t0, 36($sp) # IdentifierExp at 42.22	  
subu $sp, $sp, 8 # IdentifierExp at 42.22  	
sw $s5, 4($sp) # IdentifierExp at 42.22		
sw $t0, ($sp) # IdentifierExp at 42.22 
lw $t0, ($sp) # Minus at 42.20	
lw $t1, 8($sp) # Minus at 42.20	
subu $t0, $t1, $t0 # Minus at 42.20	
addu $sp, $sp, 8 # Minus at 42.20   
sw $t0, ($sp) # Minus at 42.20		 
jal printInt # Call at 42.9	  
subu $sp, $sp, 4 # Super at 43.9		
sw $s2, ($sp) # Super at 43.9	 	
subu $sp, $sp, 4 # StringLiteral at 43.18			
la $t0, strLit_137 # StringLiteral at 43.18		
sw $t0, ($sp) # StringLiteral at 43.18	 	
jal printStr # Call at 43.9		
subu $sp, $sp, 4 # Super at 44.9 
sw $s2, ($sp) # Super at 44.9 	
lw $t0, 28($sp) # IdentifierExp at 44.18   
subu $sp, $sp, 8 # IdentifierExp at 44.18		
sw $s5, 4($sp) # IdentifierExp at 44.18   
sw $t0, ($sp) # IdentifierExp at 44.18   
lw $t0, 44($sp) # IdentifierExp at 44.22	 	
subu $sp, $sp, 8 # IdentifierExp at 44.22 
sw $s5, 4($sp) # IdentifierExp at 44.22   
sw $t0, ($sp) # IdentifierExp at 44.22 	
lw $t0, ($sp) # Minus at 44.20			
lw $t1, 8($sp) # Minus at 44.20	  
subu $t0, $t1, $t0 # Minus at 44.20	 
addu $sp, $sp, 8 # Minus at 44.20 	
sw $t0, ($sp) # Minus at 44.20			
jal printInt # Call at 44.9	 	
subu $sp, $sp, 4 # Super at 45.9   
sw $s2, ($sp) # Super at 45.9 	 
subu $sp, $sp, 4 # StringLiteral at 45.18 
la $t0, strLit_147 # StringLiteral at 45.18 		
sw $t0, ($sp) # StringLiteral at 45.18	
jal printStr # Call at 45.9   
subu $sp, $sp, 4 # Super at 46.9  
sw $s2, ($sp) # Super at 46.9	 
lw $t0, 28($sp) # IdentifierExp at 46.18			
subu $sp, $sp, 8 # IdentifierExp at 46.18 	 
sw $s5, 4($sp) # IdentifierExp at 46.18			
sw $t0, ($sp) # IdentifierExp at 46.18 
lw $t0, 44($sp) # IdentifierExp at 46.22 		
subu $sp, $sp, 8 # IdentifierExp at 46.22  
sw $s5, 4($sp) # IdentifierExp at 46.22  	
sw $t0, ($sp) # IdentifierExp at 46.22  	
lw $t0, ($sp) # Minus at 46.20   
lw $t1, 8($sp) # Minus at 46.20	  
subu $t0, $t1, $t0 # Minus at 46.20	 	
addu $sp, $sp, 8 # Minus at 46.20	 
sw $t0, ($sp) # Minus at 46.20 	 
jal printInt # Call at 46.9	 	
subu $sp, $sp, 4 # Super at 47.9		 
sw $s2, ($sp) # Super at 47.9	 
subu $sp, $sp, 4 # StringLiteral at 47.18	 	
la $t0, strLit_157 # StringLiteral at 47.18	  
sw $t0, ($sp) # StringLiteral at 47.18  	
jal printStr # Call at 47.9	
subu $sp, $sp, 4 # Super at 48.9 		
sw $s2, ($sp) # Super at 48.9 
lw $t0, 20($sp) # IdentifierExp at 48.18	 
subu $sp, $sp, 8 # IdentifierExp at 48.18	
sw $s5, 4($sp) # IdentifierExp at 48.18  	
sw $t0, ($sp) # IdentifierExp at 48.18			
lw $t0, 44($sp) # IdentifierExp at 48.22 	
subu $sp, $sp, 8 # IdentifierExp at 48.22	 
sw $s5, 4($sp) # IdentifierExp at 48.22 	 
sw $t0, ($sp) # IdentifierExp at 48.22 
lw $t0, ($sp) # Plus at 48.20 		
lw $t1, 8($sp) # Plus at 48.20			
addu $t0, $t0, $t1 # Plus at 48.20 		
addu $sp, $sp, 8 # Plus at 48.20	 	
sw $t0, ($sp) # Plus at 48.20  
lw $t0, 36($sp) # IdentifierExp at 48.26   
subu $sp, $sp, 8 # IdentifierExp at 48.26	
sw $s5, 4($sp) # IdentifierExp at 48.26  
sw $t0, ($sp) # IdentifierExp at 48.26		
lw $t0, ($sp) # Minus at 48.24  
lw $t1, 8($sp) # Minus at 48.24	 
subu $t0, $t1, $t0 # Minus at 48.24 	
addu $sp, $sp, 8 # Minus at 48.24			
sw $t0, ($sp) # Minus at 48.24  
jal printInt # Call at 48.9			
subu $sp, $sp, 4 # Super at 49.9	 
sw $s2, ($sp) # Super at 49.9	 	
subu $sp, $sp, 4 # StringLiteral at 49.18 
la $t0, strLit_169 # StringLiteral at 49.18		
sw $t0, ($sp) # StringLiteral at 49.18			
jal printStr # Call at 49.9   
subu $sp, $sp, 4 # Super at 50.9 		
sw $s2, ($sp) # Super at 50.9 	 
lw $t0, 28($sp) # IdentifierExp at 50.18		
subu $sp, $sp, 8 # IdentifierExp at 50.18		 
sw $s5, 4($sp) # IdentifierExp at 50.18   
sw $t0, ($sp) # IdentifierExp at 50.18		 
lw $t0, 44($sp) # IdentifierExp at 50.22  
subu $sp, $sp, 8 # IdentifierExp at 50.22	 	
sw $s5, 4($sp) # IdentifierExp at 50.22 	
sw $t0, ($sp) # IdentifierExp at 50.22 
lw $t0, ($sp) # Minus at 50.20   
lw $t1, 8($sp) # Minus at 50.20			
subu $t0, $t1, $t0 # Minus at 50.20	 
addu $sp, $sp, 8 # Minus at 50.20		
sw $t0, ($sp) # Minus at 50.20 	 
lw $t0, 28($sp) # IdentifierExp at 50.26   
subu $sp, $sp, 8 # IdentifierExp at 50.26	  
sw $s5, 4($sp) # IdentifierExp at 50.26 	
sw $t0, ($sp) # IdentifierExp at 50.26   
lw $t0, ($sp) # Plus at 50.24	 	
lw $t1, 8($sp) # Plus at 50.24			
addu $t0, $t0, $t1 # Plus at 50.24  	
addu $sp, $sp, 8 # Plus at 50.24 	
sw $t0, ($sp) # Plus at 50.24 
jal printInt # Call at 50.9			
subu $sp, $sp, 4 # Super at 51.9  
sw $s2, ($sp) # Super at 51.9   
subu $sp, $sp, 4 # StringLiteral at 51.18	 
la $t0, strLit_181 # StringLiteral at 51.18 	
sw $t0, ($sp) # StringLiteral at 51.18	  
jal printStr # Call at 51.9  
subu $sp, $sp, 4 # Super at 53.9 		
sw $s2, ($sp) # Super at 53.9	  
lw $t0, 4($sp) # IdentifierExp at 53.18   
subu $sp, $sp, 4 # IdentifierExp at 53.18   
sw $t0, ($sp) # IdentifierExp at 53.18	
jal printStr # Call at 53.9	 
subu $sp, $sp, 4 # Super at 54.9 	
sw $s2, ($sp) # Super at 54.9 	 
subu $sp, $sp, 4 # StringLiteral at 54.18	 	
la $t0, strLit_189 # StringLiteral at 54.18		
sw $t0, ($sp) # StringLiteral at 54.18 		
jal printStr # Call at 54.9	  
subu $sp, $sp, 4 # Super at 55.9	 	
sw $s2, ($sp) # Super at 55.9 	
subu $sp, $sp, 4 # StringLiteral at 55.18	 
la $t0, strLit_193 # StringLiteral at 55.18	
sw $t0, ($sp) # StringLiteral at 55.18	  
jal printStr # Call at 55.9   
subu $sp, $sp, 4 # Super at 56.9	 	
sw $s2, ($sp) # Super at 56.9 
subu $sp, $sp, 4 # StringLiteral at 56.18	
la $t0, strLit_197 # StringLiteral at 56.18 		
sw $t0, ($sp) # StringLiteral at 56.18	 	
jal printStr # Call at 56.9 	 
lw $ra, 44($sp) # MethodDeclVoid at 3.14 		
lw $s2, 4($sp) # MethodDeclVoid at 3.14	 	
addu $sp, $sp, 52 # MethodDeclVoid at 3.14		 
